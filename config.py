...
LASTFM_CACHE          = os.path.join(DATA_DIR, "lastfm_cache.json")
SPOTIFY_SEARCH_CACHE  = os.path.join(DATA_DIR, "spotify_search_cache.json")
SPOTIFY_CATALOG_CACHE = os.path.join(DATA_DIR, "spotify_catalog_cache.json")
